...
module.exports = {
    ...
    ALIVEIMG: process.env.ALIVEIMG === undefined ? 'https://i.ibb.co/WGNfQhB/IMG-20210820-001112.jpg' : process.env.ALIVEIMG,
    ...
    CAPTION_KEY: process.env.CP === undefined ?'❰🍁🔱  T Rex BOT  🔱🍁❱' : process.env.CP,
    LOGO_KEY: process.env.LOGOAPI === undefined ?'B6FlBogm1ELO1Z52WigX70G1TOe' : process.env.LOGOAPI,
    ALIVETEXT: process.env.ALIVENAME === undefined ?'❰🍁🔱  T Rex BOT  🔱🍁❱' : process.env.ALIVENAME,
