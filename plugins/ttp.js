...
clh.pay = ddd
var desc_msg = ''
if (Config.LANG == 'SI') desc_msg = 'T-Rex ලොගෝ පැක්'
if (Config.LANG == 'EN') desc_msg = 'T-Rex Logo Pack'
const need = "*type some word after command*\n*විධානයට පසුව වචනයක් ලියන්න"
if (os.userInfo().homedir !== clh.pay) return;
let wk = Config.WORKTYPE == 'public' ? false : true

XTroid.addCMD({pattern: 'tpack$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
    ...
    const msg = command_cmd + '```.devil``` \n' + t1 + '_\n' + usage_cmd + '*.devil Trex*\n\n' +
        command_cmd + '```.bear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '*.bear Trex*\n\n' +
        command_cmd + '```.wolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '*.wolf Trex,Hiruwa*\n\n' +
        command_cmd + '```.neon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '*.neon Trex*\n\n' +
        command_cmd + '```.2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '*.2neon Trex*\n\n' +
        command_cmd + '```.3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '*.3neon Trex*\n\n' +
        command_cmd + '```.4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '*.4neon Trex*\n\n' +
        command_cmd + '```.light``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '*.light Trex*\n\n' +
        command_cmd + '```.joker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '*.joker Trex*\n\n' +
        command_cmd + '```.ninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '*.ninja Trex,Hiruwa*\n\n' +
        command_cmd + '```.glitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '*.glitter Trex*\n\n' +
        command_cmd + '```.bokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '*.bokeh Trex*\n\n' +
        command_cmd + '```.marvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '*.marvel Trex,Hiruwa*\n\n' +
        command_cmd + '```.2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '*.2marvel Trex,Hiruwa*\n\n' +
        command_cmd + '```.avengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '*.avengers Trex,Hiruwa*\n\n' +
        command_cmd + '```.graf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '*.graf Trex,Hiruwa*\n\n' +
        command_cmd + '```.2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '*.2graf Trex,Hiruwa*\n\n' +       
        command_cmd + '```.lion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '*.lion Trex,Hiruwa*\n\n' +
        command_cmd + '```.ice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '*.ice Trex*\n\n' +
        command_cmd + '```.space``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '*.space Trex,Hiruwa*\n\n' +
        command_cmd + '```.smoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '*.smoke Trex*\n\n' + // Thanks for @Unique_hunter for base.
        command_cmd + '```.fire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '*.fire Trex*\n\n' +
        command_cmd + '```.harry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '*.harry Trex*\n\n' +
        command_cmd + '```.cup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '*.cup Trex*\n\n' +
        command_cmd + '```.cemetery``` \n' + desc_cmd + t28 + '_\n' + usage_cmd + '*.cemetery Trex*\n\n' +
        command_cmd + '```.glitch``` \n' + desc_cmd + t14 + '_\n' + usage_cmd + '*.glitch Trex,Hiruwa*\n\n'
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/lil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/lil.jpg'), MessageType.image, { caption:  '❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/devil.jpg'), MessageType.image, { caption:   '❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/bear.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/wolf.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/neon.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/neon2.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/li.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/joker.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/ninja.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/tt.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/bkh.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/marvel.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/mar2.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/aven.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/tt2.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/ttgra.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/lizy/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/lizy/t2gra.jpg'), MessageType.image, { caption:  ' ❰🍁🔱  T Rex BOT NEW  🔱🍁❱'})
              })
          } catch(err) { 
              console.log(err)
          } 
