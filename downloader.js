...
Trex.addCMD({ pattern: 'insta ?(.*)', fromMe: false, desc: IG_DESC}, async (message, match) => {
...
Trex.addCMD({ pattern: 'fb ?(.*)', fromMe: false, desc: FBDESC }, async (message, match) => {
