...
${chalk.blue.italic('🚀 Connecting to your ❰🍁🔱  T Rex BOT NEW  🔱🍁❱... Please Wait.')}`);
    });
    conn.on('credentials-updated', async () => {
        console.log(
            chalk.green.bold('✅ ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ Login successful!')
        );
        console.log(
        ...
        console.log(chalk.bgGreen('🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱' + aftroid));
        await new Promise(r => setTimeout(r, 500));
        let LIZA_ACTION = config.LANG == 'SI' || config.LANG == 'EN'? '*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ චැට්බෝට් ලෙස ක්රියා කරයි!*  \n\nමෙම ප්රකාරයේ පරමාර්ථය වන්නේ bot සම්පුර්ණයෙන්ම ක්රියාකාරී කෘතිම බුද්ධියට හරවා ගැනීමයි.\n_කෘතීම බුද්ධිය ඉවත් කිරීමට_ *.liza off* _ඔබට ඔබේ විධානය භාවිතා කළ හැකිය._\n\n*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ භාවිතා කිරීම ගැන ස්තූතියි....💌*\n    *- Liza*' : '*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ Working as a clhatbot!  *\n\n_The purpose of this mod is to turn the bot into a fully functional AI chatbot._\n_You can use the_ *.liza off* _command to return to normal mode._\n\n*Thanks For Using 🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ 💌*\n    *- Liza*'
        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'TR' || config.LANG == 'AZ') { 
                if (config.AILIZA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ Private  ලෙස ක්රියා කරයි!  *\n\n_මෙය ඔබගේ ලොග් සටහන් අංකය බැවින් මෙහි එන පණිවුඩ සහා අවධානයෙන් සිටින්න._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය නමුත් මෙහි නොකරන්න:)_\n\n*bot පොදු කිරීමට .වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *ඔබේ විධානය භාවිතා කරන්න.*\n\n*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ භාවිත කලාට ස්තූතී...💌*', MessageType.text);
                }
                await git.fetch();
                var commits = await git.log([config.BRANCH + '..origin/' + config.BRANCH]);
                if (commits.total === 0) {
                ...
                if (config.AILIZA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '\n*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱  Working as Private! 🍁➢*\n\n_Please do not try plugins here. This is your LOG number._\n_You can try commands to any chat :)_\n\n*Your bot working as private. To change it, use* _.setvar WORK_TYPE:public_\n\n*Thanks for using 🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ 💌*', MessageType.text);
                }
                await git.fetch();
                var commits = await git.log([config.BRANCH + '..origin/' + config.BRANCH]);
                if (commits.total === 0) {
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱] --*' + 
                                    '\n*🚀 ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ bir hata gerçekleşti!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [🚀  ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ ] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [🚀  ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ ] --*' + 
                                    '\n*🚀  ❰🍁🔱  T Rex BOT NEW  🔱🍁❱  an error has occurred!*'+
                                    ...
                                    '\n*Aslo you can join our support group:* https://chat.whatsapp.com/GT5V8RakkftB7DAKWMeQML' +
                                    '\n*This message should have gone to your number (saved messages).*\n\n' +
                                    '*Error:* ```' + error + '```\n\n'
                                    , MessageType.text, {detectLinks: false}
                                );
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [🚀  ❰🍁🔱  T Rex BOT NEW  🔱🍁❱ ] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*🍁 ➢ Sorry, I Couldnt Read This Error 🍁➢*' +
                                        '\n_You can write to our support group for more help. https://chat.whatsapp.com/GT5V8RakkftB7DAKWMeQML _'
                                        , MessageType.text
                                    );
                                }    
                            }                      
